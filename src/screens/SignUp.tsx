  ...
  return (
    ...
    >
      <VStack flex={1} px={12} bgColor='gray.600'>
        <Center mt={20} mb={5}>
          <LogoSvg />
          <Heading fontSize='3xl' color="gray.100" fontWeight='bold'>Boas vindas!</Heading>
          <Text color='gray.300' mt={2} fontSize='sm' textAlign='center'>Crie sua conta e use o espaço para comprar itens variados e vender seus produtos</Text>
        </Center>
        ...
        <Center>
          ...
          <Input placeholder='Senha' type={showConfirmPassword ? 'text' : 'password'} InputRightElement={
            <ButtonNativeBase
              rounded='none'
              h='full'
              variant='link'
        ...
        <Center my={10}>
          ...
          <Button bgColor="gray.500" colorText="gray.200" title="Ir para o login" />
        </Center>
